...
#
  ...
  tests = Test.create([{title: "HTML", category_id: categories.first.id, user_id: users.last.id },{title:"Ruby", level: "1", category_id:categories.last.id, user_id:users.last.id}])
